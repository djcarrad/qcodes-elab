...
class Keithley_2600(VisaInstrument):
    ...
    def __init__(self, name: str, address: str, channel: str,
        ...
        warnings.warn("This Keithley driver is old and will be removed "
                      "from QCoDeS soon. Use Keithley_2600_channels instead, it is MUCH better."
                      "DJC note: Not really true. If you only need to source voltages and measure currents, this driver is completely fine, and in fact is less problematic than newer versions. If you need to do anything more than that, we'll work out a solution.", UserWarning)
        ...
        knownmodels = ['2601B', '2602B', '2604B', '2611B', '2612',
                       '2614B', '2635B', '2636B']
