...
# Added by Timo. Copied the QConductanceParameter4pt class to get a differential resistance parameter
class QResistanceParameter4pt(MultiParameter):
    def __init__(self, volt_param, curr_param, v_amp_ins, c_amp_ins, name='resistance'):
        p_name = 'resistance'
    ...
    def get(self):
        ...
        if curr == 0:
            curr = 0.0000000001
        conductance = volt/curr / 12906 # Legacy variable name

        value = (conductance, volt)
        self._save_val(value)
        return value

class QResistanceParameterDAC4pt(MultiParameter):
    def __init__(self, volt_param, curr_param, v_amp_ins, c_amp_ins, name='conductance'):
        p_name = 'resistance'
